...
<div class="container-fluid">
    <div class="flash-sale-header d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h3 mb-0">Edit Flash Sale</h1>
            <p class="mb-0 mt-2 opacity-75">
                <i class="fas fa-info-circle me-1"></i> Update information and products for this flash sale
            </p>
        </div>
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="discount-percentage text-success mt-1 small">
                                                    @php
                                                        $discountPercent = round((($product->price - $product->pivot->sale_price) / $product->price) * 100);
                                                    @endphp
